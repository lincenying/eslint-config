...
export type ConfigNames = 'eslint:comments' | 'eslint:formatters:setup' | 'eslint:imports:rules' | 'eslint:imports:disables:bin' | 'eslint:javascript:setup' | 'eslint:javascript:rules' | 'eslint:scripts:disables' | 'eslint:jsdoc:rules' | 'eslint:jsonc:setup' | 'eslint:jsonc:rules' | 'eslint:markdown:setup' | 'eslint:markdown:processor' | 'eslint:markdown:parser' | 'eslint:markdown:disables' | 'eslint:node:rules' | 'eslint:perfectionist:setup' | 'eslint:react:setup' | 'eslint:react:rules' | 'eslint/regexp/rules' | 'eslint:sort-package-json' | 'eslint:stylistic' | 'eslint:test:setup' | 'eslint:test:rules' | 'eslint:toml:setup' | 'eslint:toml:rules' | 'eslint:typescript:setup' | 'eslint:typescript:parser' | 'eslint:typescript:rules' | 'eslint:typescript:disables:dts' | 'eslint:typescript:disables:test' | 'eslint:typescript:disables:cjs' | 'eslint:unicorn' | 'eslint:unocss' | 'eslint:vue:setup' | 'eslint:vue:rules' | 'eslint:yaml:setup' | 'eslint:yaml:rules'
