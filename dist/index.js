...
import fs2, { promises as promises2 } from "fs";
...
var DEFAULT_URL = pathToFileURL(process.cwd());
...
function lincy(options = {}, ...userConfigs) {
  const {
    isInEditor = !!((process4.env.VSCODE_PID || process4.env.JETBRAINS_IDE) && !process4.env.CI),
