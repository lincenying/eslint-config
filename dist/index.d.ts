 ...
 * 构造一个ESLint扁平化配置项数组。
 */
declare function lincy(options?: OptionsConfig & TypedFlatConfigItem, ...userConfigs: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[]>[]): FlatConfigPipeline<TypedFlatConfigItem>;
